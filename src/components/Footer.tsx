...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/YOUR_USERNAME",        // ← Put your GitHub profile URL here
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/YOUR_USERNAME",    // ← Put your LinkedIn profile URL here
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "X / Twitter",
    href: "https://x.com/YOUR_USERNAME",              // ← Put your X/Twitter profile URL here
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Email",
    href: "mailto:YOUR_EMAIL@example.com",            // ← Put your email address here
    icon: (
